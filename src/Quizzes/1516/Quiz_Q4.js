...
function Quiz({navigation, route}) {
    ...
    return (
        <SafeAreaView style={styles.content}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Quiz_1415_Q4_Incorrect', {score: score})} style={styles.menuButton}><Text style={styles.buttonText}>D. Escalate the situation and steal their homwork</Text></TouchableOpacity>
        </SafeAreaView>
    );
}
