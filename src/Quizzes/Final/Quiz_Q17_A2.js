    ...
    return (
        <SafeAreaView style={styles.content}>
            ...
            <View style={[styles.menuButton, {flex: 0.35, marginTop: 20, marginBottom: 30}]}>
                <Text style={styles.buttonText}>Nice decision! Approaching someone new with good body language and a smile is an excellent way to give a friendly introduction. It not only makes the conversation easier, but also leaves a good impression.</Text>
            </View>
