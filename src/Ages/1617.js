    ...
    return (
        <SafeAreaView style={styles.content}>
            ...
            <View style={styles.ageScreenImageHolder}>
                <Image style={{width: '100%', height: '100%'}} source={require('../../assets/animal.gif')} />
            </View>
            <View style={styles.ageScreenMenu}>
                <TouchableOpacity onPress={() => Linking.openURL('https://www.youtube.com/watch?v=EVO_Zmq-Wmc')} style={styles.ageScreenMenuButton}><Text style={styles.buttonText}>Instructional Video</Text></TouchableOpacity>
